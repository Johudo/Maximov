...
import { ProductAPI, ProductAPIGetProductData } from "../../api/ProductAPI";
...
ProductPage.getInitialProps = wrapper.getInitialPageProps((store) => async (context: NextPageContext) => {
    ...
    let product: ProductAPIGetProductData | undefined = undefined;
...
type ProductPageProps = { product?: ProductAPIGetProductData };
